...
// };
    ...
    return (
        <div className='relative w-full'>
            ...
            <div className='flex  w-full  max-[425px]:flex-col  min-h-screen relative top-[125px]'>
                <div className='w-[70vw]   max-[425px]:h-[87vh] max-[768px]:h-[100vh] max-[425px]:w-full  h-[80vh] p-5 relative'>
                    ...
                    <div className='absolute top-[120px] max-[425px]:left-10 max-[425px]:top-[50px] max-[768px]:top-[60px] max-[768px]:left-10 left-16'>
                        <h4 className='text-xl mb-3 text-blue-600 font-medium max-[425px]:text-sm max-[425px]:mb-1 '>Elegant & Stylish</h4>
                        <h1 className='text-5xl font-bold leading-16 mb-10 max-[425px]:text-3xl max-[425px]:w-[280px] max-[425px]:mb-5 max-[768px]:text-4xl'> Dresses  <br />For Every Occasion</h1>
                        <h6 className='text-xl mb-2 max-[425px]:text-sm'>Starting At</h6>
                        <h3 className='text-4xl font-bold max-[425px]:text-3xl max-[425px]:mb-3   text-pink-500 mb-5'> ₹ 800</h3>

                        <button name='womens-dresses' className='bg-black hover:bg-yellow-600 px-4 py-2 rounded-full max-[425px]:text-sm text-white font-medium active:scale-105' onClick={setCheck}>Shop Now <i className="ri-arrow-right-s-line"></i></button>
                    </div>
                </div>
                ...
                <div className='w-[30vw] flex gap-2 flex-col max-[425px]:w-full  h-[80vh] p-5'>
                    <div className='relative'>
                        ...
                        <div className='absolute top-5 left-3  max-[425px]:top-2 max-[768px]:top-1'>
                            ...
                            <h6 className='text-lg text-green-600 font-extrabold mb-1 max-[425px]:mb-0 max    -[768px]:mb-0'>Starting At</h6>
                            <h3 className='text-3xl font-bold max-[425px]:text-2xl max-[425px]:mb-0  text-red-500 mb-2'>₹ 350</h3>
                            <button name='mens-shoes' className='bg-black hover:bg-green-700 px-3 py-2 rounded-full max-[768px]:px-2 max-[768px]:py-1 max-[425px]:text-sm text-white font-medium active:scale-105' onClick={setCheck} >Shop Now <i className="ri-arrow-right-s-line"></i></button>
                        </div>
                    </div>
                    <div className='relative'>
                        ...
                        <div className='absolute top-5 left-3  max-[425px]:top-2 max-[768px]:top-2'>
                            ...
                            <h3 className='text-3xl font-bold max-[425px]:text-2xl max-[425px]:mb-1 max-[768px]:mb-0  text-purple-500 mb-2'>₹ 200</h3>
                            <button name='mens-watches' className='bg-black hover:bg-red-700 px-3 py-2 rounded-full max-[768px]:px-2 max-[768px]:py-1  max-[425px]:text-sm text-white font-medium active:scale-105' onClick={setCheck} >Shop Now <i className="ri-arrow-right-s-line"></i></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* categories */}
            <div className='min-h-60 font-extrabold bg-gray-300 text-pink-500  w-full bg-transparent p-5 flex flex-wrap gap-3 relative max-[425px]:top-[45vh]  max-[768px]:top-[35vh]'>
