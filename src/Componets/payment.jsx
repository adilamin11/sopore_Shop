...
import Nav from './nav';
import Qr from "../assets/Google_pay.jpeg";
import { useNavigate } from 'react-router-dom';
import { ToastContainer, toast } from 'react-toastify';
import jsPDF from 'jspdf';
import html2canvas from 'html2canvas';
import logo from "../assets/adil.jpg"
                ...
                >
                    ...
                    <div className='flex justify-between items-center mb-6'>
                        <div className='flex items-center gap-3'>
                            ...
                            <div>
                                <h1 className='text-xl font-bold text-gray-800'>SoporeShop</h1>
                                <p className='text-gray-500 text-xs'>Fresh Groceries from Sopore</p>
                            </div>
                        </div>
                    ...
                    <div className='mb-4 text-xs'>
                        <p><strong>From:</strong> SoporeShop, Baramulla, J&K, 193201</p>
                        <p><strong>Contact:</strong> +91-9070467011</p>
                        <p><strong>Email:</strong> aadilaminrather@gmail.com</p>
                        <hr className='my-2' />
                    ...
                    <div className='mt-6 text-center text-gray-400 text-xs'>
                        <p>Thank you for shopping with Sopore Bazar!</p>
                        <p>www.SoporeShop.com</p>
                    </div>
                </div>
            </div>
