...
const detail = () => {
    ...
    return (
        <>
            <Nav />
            <div className='w-[100%] relative top-32 p-5 h-[91vh] bg-zinc-300'>
                <form action="https://formspree.io/f/xyzpwloy"
                            method="POST">
                    <div className='mb-5'>
                        <h2 className='text-3xl font-extrabold text-gray-800  mb-1'>Your Address Details</h2>
                    ...
                    <div className='flex gap-5 mb-2'>
                     ...
                     <button
                                ...
                                className='bg-yellow-400 font-extrabold text-black px-6 py-2 rounded hover:bg-pink-600 transition-all active:scale-95 shadow-md'
                            >
                                Add Adress 
                            </button>
