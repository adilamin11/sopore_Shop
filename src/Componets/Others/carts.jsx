...
const Cart = ({ url, title, price }) => {
    ...
    return (
        <div className='bg-white max-[425px]:w-full flex-shrink-0 w-[260px] min-h-[350px] hover:bg-yellow-600 transform transition-transform duration-300 hover:scale-110 p-3 border-2 rounded border-gray-200'>
            ...
            <div className='flex items-center justify-between text-white'>
                ...
                <button onClick={add} className='bg-green-500 hover:bg-pink-600  px-3 py-2 active:scale-95 rounded font-medium'>Add to Cart</button>
            </div>
        </div>
    )
}
